...
# KM curves
## AF
af_set[,vo2_graphical := factor(ifelse(vo2_less10pct==1,'Below','Above'),levels=c('Below','Above'))]
...
plot(mod_af,"cuminc",ylim=c(0,0.40),xlim=c(0,10), # Remove cuminc if you want survival
     ...
     legend.cex=1.8,legend.legend=c("Below 10th percentile","Above 10th percentile"), # more legend parameters
...
## MI
mi_set[,vo2_graphical := factor(ifelse(vo2_less10pct==1,'Below','Above'),levels=c('Below','Above'))]
...
## HF
hf_set[,vo2_graphical := factor(ifelse(vo2_less10pct==1,'Below','Above'),levels=c('Below','Above'))]
...
## Death
death_set[,vo2_graphical := factor(ifelse(vo2_less10pct==1,'Below','Above'),levels=c('Below','Above'))]
...
vo2_less10pct_hf <- boot_cmp(time='time_to_hf',status='failure',data=hf_set,runs=200,exposure='vo2_less10pct')
